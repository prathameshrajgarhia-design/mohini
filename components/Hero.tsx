    ...
    <section className="relative h-[90vh] min-h-[650px] flex items-center overflow-hidden bg-black mb-24 md:mb-32">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-stone-900/40 via-stone-900/10 to-transparent"></div>
        </motion.div>
      </AnimatePresence>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full pt-12">
        <div className="max-w-4xl">
          ...
          >
            <div className={`h-[1px] w-12 ${slides[index].accent}`}></div>
            <span className="text-white text-[10px] font-bold uppercase tracking-[0.4em]">Precision Manufacturing</span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-bold text-white leading-tight mb-6 tracking-normal"
          >
            Shading and <br />
            Tenting Solutions <br />
            <span className="text-stone-300 font-light text-lg md:text-2xl tracking-normal">by Mohini Tradelink</span>
          </motion.h1>
